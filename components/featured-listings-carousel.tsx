...
export function FeaturedListingsCarousel({ listings = [] }: { listings: Listing[] }) {
    ...
    listings.length > 0
      ...
      : (Array.from({ length: 8 }).map((_, i) => ({
          ...
          fields: {
            ...
            description: "Explore the beautiful underwater world of the Red Sea with expert guides.",
            "price/retailPrice/amount": 99,
            "rating/score": 4.8,
            "rating/reviewCount": 24,
            location: "Hurghada",
          },
        })) as Listing[])
